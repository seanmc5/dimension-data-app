...
public class UpdateCommandTest {
  ...
  public void updateCommandTest() {
    ...
    assertThat(shell.evaluate(() -> "update-server 1 Server2 Description2"))
      .isEqualTo(
        "--- Updated ---\n" +
          "id: 1, name: Server2, description: Description2, createdDate: 1916-04-24T08:00:00Z, lastUpdatedDate: 1916-04-24T08:00:00Z"
      );
